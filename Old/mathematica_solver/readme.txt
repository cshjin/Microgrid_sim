...
I.  CONTENTS
    ...
    Below are descriptions of the five directories at this level.
    ...
    A. products directory
       ...
       1. auxiliary - contains free-formatted files in two subdirectories:
	  ...
	  b. high-precision-degree-days - contains daily heating and cooling 
       ...
       2. hourly - contains all normals derived from hourly data, including
       ...
       3. precipitation - contains all precipitation, snowfall, and snow depth 
          normals files including percentiles, frequencies, and averages.
       4. temperature - contains all temperature-related normals files, including 
    ...
    B. station-inventories directory
       ...
       1. allstations.txt contains all stations in this Normals release
    ...
    C. documentation directory
       ...
       1. Arguez-Extended-Normals-AMS2012.pdf is an extended abstract from the
          2012 American Meteorological Society Annual Meeting in New Orleans entitled
	  "NOAA's 1981-2010 U.S. Climate Normals: An Overview"
       2. hourly-filenames.txt lists the filenames and descriptions of files
          containing the normals derived from hourly data
       3. hourly-methodology.pdf describes the methodology utilized to compute all
          normals calculated from hourly data
       4. precipitation-filenames.txt lists the filenames and descriptions of files
          containing the precipitation-related normals
       5. precipitation-methodology.pdf describes the methodology utilized to
          compute precipitation, snowfall, and snow depth normals
       6. temperature-filenames.txt lists the filenames and descriptions of files
          containing the temperature-related normals
       7. temperature-methodology.pdf describes the methodology utilized to 
          compute all temperature-related normals
       8. tobadj.inventory.txt is an inventory of stations for which a time of 
    ...
    E. supplemental directory
       ...
       A separate readme and status file describing this newer product is found in 
       the supplemental directory.

II. FILENAMING

    Except for the auxiliary normals files, all other normals files are named
